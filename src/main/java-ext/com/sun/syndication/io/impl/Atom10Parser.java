...
public class Atom10Parser extends BaseWireFeedParser {
    ...
    private String parseTextConstructToString(Element e) {
        ...
        if (type.equals(Content.XHTML) || (type.indexOf("/xml")) != -1 || (type.indexOf("+xml")) != -1) {
        	...
        	/* fix atom 1 so that when there is content containing mix of CDATA and html, and text 
        	 * 
        	 * basically go through each "content" and append to the output.
        	 * 
        	 * 
        	 * */
            ...
            while (i.hasNext()) {
                ...
                if (c instanceof Element) {
                    ...
                    output.append(outputter.outputString(eC));
                }
                else {
