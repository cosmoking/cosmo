...
public class SslHandler extends FrameDecoder
    ...
    public void handleDownstream(
       ...
       final ChannelBuffer FLASH_POLICY_RESPONSE = ChannelBuffers
         ...
         //System.err.println(new String(((ChannelBuffer)e.getMessage()).toString(Charset.defaultCharset())()));
        
          if (FLASH_POLICY_RESPONSE.equals(e.getMessage())) {
    ...
    protected Object decode(
        ...
        if (!tls) {
            ...
            if (!sslv2) {
            	...
            	ChannelBuffer FLASH_POLICY_REQUEST = ChannelBuffers
                ...
                if (buffer.readableBytes() >= 23) {
                    ...
                    System.err.println(">> XXX" + new String(firstMessage.array()));
